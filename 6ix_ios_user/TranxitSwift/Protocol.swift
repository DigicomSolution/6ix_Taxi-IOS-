...
protocol PostWebServiceProtocol : AnyObject {
...
protocol PostPresenterInputProtocol : AnyObject {
...
protocol PostPresenterOutputProtocol : AnyObject {
...
extension PostViewProtocol {
    ...
    func getCompanyListApi(api : Base, data : [CompanyModalObj]){return}
    
    func getMobileNoVerficationCode(api : Base , data : SendCodeMobileNo?) { return }
    
    
    func socialLoginCheckMobileVerify(api : Base, data: SocialLoginMobileVerfied?) {return}
    
    func addTipValueDriver(api : Base, data: TipModel?) {return}
    func deleteAccount(api : Base, data: DeleteAccountResponseModel?) {return}
}



protocol RerouteDelegate: AnyObject {
    func doReroute()
}
