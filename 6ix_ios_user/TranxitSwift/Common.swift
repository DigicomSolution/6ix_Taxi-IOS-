...
class Common {
    ...
    class func storeUserData(from profile : Profile?){
        ...
        User.main.company_id = profile?.company_id
        User.main.emp_id = profile?.emp_id
        User.main.company_name = profile?.company_name
        User.main.corp_deleted = profile?.corp_deleted
        User.main.walletLimit  = profile?.user_negative_wallet_limit
