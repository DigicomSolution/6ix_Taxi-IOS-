...
extension UIViewController {
    ...
    func showInputDialog(title:String? = nil,
            ...
            alert.addAction(UIAlertAction(title: actionTitle, style: style, handler: { (action:UIAlertAction) in
    ...
    func presentFeedbackViewController(feedbackInterfaceData: FeedbackInterfaceData, feedbackOptions: [FeedbackOption], onAction: @escaping (String) -> Void){
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: Storyboard.Ids.FeedbackViewController) as! FeedbackViewController
        vc.modalPresentationStyle = .overFullScreen
        vc.modalTransitionStyle = .coverVertical
        //DATA SOURCE
        vc.feedbackInterfaceData = feedbackInterfaceData
        vc.feedbackOptions = feedbackOptions
        vc.onAction { reason in
            onAction(reason)
        }
